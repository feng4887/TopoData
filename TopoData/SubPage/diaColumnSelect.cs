...
{
    public partial class diaColumnSelect : DevExpress.XtraEditors.XtraForm
    {
        ...
        bool _MultiSelect;
        public diaColumnSelect(bool MultiSelect = false)
        {
            InitializeComponent();
        ...
        private void btOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!rbInternal.Checked && string.IsNullOrEmpty(tbTagName.Text))
                {
                    MessageBox.Show("通讯点位不能为空");
                    return;
                }

                if (rbInternal.Checked && string.IsNullOrEmpty(tbDefaultValue.Text))
                {
                    MessageBox.Show("内存默认值不能为空");
                    return;
                }

                DefaultValue = tbDefaultValue.Text;
                isInternalValue = rbInternal.Checked;
