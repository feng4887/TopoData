...
namespace TopoData.SubPage
{
    partial class diaColumnSelect
    {
        ...
        private void InitializeComponent()
        {
            ...
            // tbAtribute
            // 
            tbAtribute.Location = new Point(96, 25);
            tbAtribute.Margin = new Padding(3, 2, 3, 2);
            tbAtribute.Name = "tbAtribute";
            tbAtribute.Size = new Size(234, 20);
            ...
            // tbTagName
            // 
            tbTagName.Location = new Point(99, 120);
            ...
            tbTagName.Size = new Size(181, 20);
            ...
            // tbUOM
            // 
            tbUOM.Location = new Point(99, 171);
            tbUOM.Margin = new Padding(3, 2, 3, 2);
            tbUOM.Name = "tbUOM";
            tbUOM.Size = new Size(231, 20);
            tbUOM.TabIndex = 5;
            // 
            // label4
            // 
            ...
            // btOK
            // 
            btOK.Location = new Point(158, 210);
            btOK.Margin = new Padding(3, 2, 3, 2);
            btOK.Name = "btOK";
            btOK.Size = new Size(76, 25);
            btOK.TabIndex = 8;
            btOK.Text = "确认";
            ...
            // btCancel
            // 
            btCancel.Location = new Point(254, 210);
            btCancel.Margin = new Padding(3, 2, 3, 2);
            btCancel.Name = "btCancel";
            btCancel.Size = new Size(76, 25);
            btCancel.TabIndex = 9;
            btCancel.Text = "取消";
            ...
            // btSelect
            // 
            btSelect.Location = new Point(286, 119);
            btSelect.Margin = new Padding(3, 2, 3, 2);
            btSelect.Name = "btSelect";
            btSelect.Size = new Size(44, 20);
            ...
            rbDevice.Location = new Point(99, 49);
            rbDevice.Margin = new Padding(3, 2, 3, 2);
            rbDevice.Name = "rbDevice";
            rbDevice.Size = new Size(85, 18);
            rbDevice.TabIndex = 15;
            rbDevice.TabStop = true;
            rbDevice.Text = "设备通讯点";
            rbDevice.UseVisualStyleBackColor = true;
            rbDevice.CheckedChanged += rbDevice_CheckedChanged;
            // 
            // rbInternal
            // 
            rbInternal.AutoSize = true;
            rbInternal.Location = new Point(99, 72);
            rbInternal.Margin = new Padding(3, 2, 3, 2);
            rbInternal.Name = "rbInternal";
            rbInternal.Size = new Size(85, 18);
            rbInternal.TabIndex = 16;
            rbInternal.Text = "内存默认值";
            rbInternal.UseVisualStyleBackColor = true;
            rbInternal.CheckedChanged += rbInternal_CheckedChanged;
            // 
            // cbDataType
            // 
            cbDataType.Location = new Point(99, 147);
            ...
            cbDataType.Size = new Size(231, 20);
            ...
            ClientSize = new Size(368, 244);
            Controls.Add(cbDataType);
            Controls.Add(rbInternal);
            Controls.Add(rbDevice);
            Controls.Add(label5);
